...
/*
 * Main object class, contains all information for each shop panel,
 * as well as some other information that had to be constantly passed
 * through different classes.
 */
public class ShopObjects {

	// THE FOLLOWING ARE ALL LINKED TO EACH DROID INDIVIDUALLY THROUGH THE ARRAY
	
	// cost of the droid
	private double[] Cost = new double[8];
	
	// number of droids owned
	private int[] numberBought = new int[8];
	
	// revenue per cycle
	private int[] revenue = new int[8];
	
	// true if manager owned, else false
	private boolean[] manager = new boolean[8];
	
	// true if progress bar is running, else false
	private boolean[] running = new boolean[8];
	
	// base cost used for calculating cost later
	private final double[] firstCost = new double[8];
	
	// coefficient used to calculate cost
	private final double[] coefficient = new double[8];
	
	// base revenue used for calculating revenue later
	private final int[] initialRevenue = new int[8];
	
	// cycle time for each progress bar
	private double[] cycleTime = new double[8];
	
	// height of droid picture
	private int[] height = new int[8];
	
	// width of droid picture
	private int[] width = new int[8];
	
	// description of each droid
	private final String[] description = new String[8];
	
	// name of each droid
	private final String[] name = new String[8];
	
	// file of picture name
	private final String[] link = new String[8];

	// OTHER VARIABLES
	
	// current buy option(1, 10, 100, or max/1000)
	private int BuyOption = 1;
	
	// users current total money
	private double TotalMoney;

	// true if upgrade was bought, else false
	private boolean[] boughtUpgrade = new boolean[9];

	// true if unlock was unlocked, used to make cycle time faster
	...
	// index of profile picture, 20 is default as ahsoka
	private int profileIndex = 20;
	
	// upgrade for monopoly (all revenue times 3) true if bought
	private boolean monopoly = false;

	/*
	 * Initialize all constants for each droid
	 */
	public ShopObjects() {
		coefficient[0] = 1.07;
		initialRevenue[0] = 1;
	...
	// Accessors and mutators for number of droids owned
	...
	// Accessors and mutators for whether manager is owned
	...
	// Accessors and mutators for whether progress bar is running/should be running
	...
	// Accessors and mutators for whether upgrade has been bought
	...
	// Accessors and mutators for buy option
	...
	// Accessors and mutators for profile index
	...
	// Accessors and mutators for monopoly upgrade 
	...
	// Accessors and mutators for total money
	...
	// format numbers by changing them to words, e.g 1 million
	...
	// return revenue/revenue as a string
	...
	// change cycle speed of progress bar
	...
	// purchase method for when droid is bought, separate method for when max droids are bought
	...
	// return cost of droid, int i number of droids being purchased
	...
	// get the maximum number of droids that can be bought
	...
	// get maximum droids to buy cost
